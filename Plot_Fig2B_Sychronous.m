%% Plot  Figure 2B - PMR variation across sampling different initial median parasite age
...
text(0.01,9.5,'(B) Simulated synchronous infection','fontname','Arial','fontsize',24)
